...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LumenAI — Your AI Personal Tutor" },
      ...
      { property: "og:title", content: "LumenAI — Your AI Personal Tutor" },
      { property: "og:description", content: "AI study plans, notes, adaptive quizzes, and a tutor that adapts to you." },
